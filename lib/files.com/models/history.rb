...
module Files
  class History
    ...
    def self.list_for_file_create_export(path, params = {}, options = {})
      ...
      response, options = Api.send_request("/history/files/create_export", :post, params, options)
    ...
    def self.list_for_folder_create_export(path, params = {}, options = {})
      ...
      response, options = Api.send_request("/history/folders/create_export", :post, params, options)
      Export.new(response.data, options)
    end
