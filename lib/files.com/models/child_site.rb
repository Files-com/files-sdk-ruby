...
module Files
  class ChildSite
    ...
    def save
      if @attributes[:id]
        raise NotImplementedError.new("The ChildSite object doesn't support updates.")
      else
        new_obj = ChildSite.create(@attributes, @options)
      end
    ...
    def self.list(params = {}, options = {})
      ...
      List.new(Site, params) do
        Api.send_request("/child_sites", :get, params, options)
      end
    end
    ...
    def self.create(params = {}, options = {})
      ...
      response, options = Api.send_request("/child_sites", :post, params, options)
      Site.new(response.data, options)
    end

    def self.create_export(params = {}, options = {})
      response, options = Api.send_request("/child_sites/create_export", :post, params, options)
