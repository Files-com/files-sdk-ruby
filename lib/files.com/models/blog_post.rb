...
module Files
  class BlogPost
    ...
    def self.list(params = {}, options = {})
      ...
      List.new(BlogPost, params) do
        Api.send_request("/blog_posts", :get, params, options)
      end
    end
    ...
    def self.create_export(params = {}, options = {})
      ...
      response, options = Api.send_request("/blog_posts/create_export", :post, params, options)
