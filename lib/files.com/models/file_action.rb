...
module Files
  class FileAction
    ...
    def copy(params = {})
      ...
      Api.send_request("/file_actions/copy/#{URI.encode_www_form_component(@attributes[:path])}", :post, params, @options)
    end
    ...
    def move(params = {})
      ...
      Api.send_request("/file_actions/move/#{URI.encode_www_form_component(@attributes[:path])}", :post, params, @options)
    end
    ...
    def begin_upload(params = {})
      ...
      Api.send_request("/file_actions/begin_upload/#{URI.encode_www_form_component(@attributes[:path])}", :post, params, @options)
    end
