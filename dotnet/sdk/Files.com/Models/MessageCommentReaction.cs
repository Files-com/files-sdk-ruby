...
namespace Files.com.Models
{
    public class MessageCommentReaction
    {
        ...
        )
        {
            ...
            string responseJson = await FilesApi.SendRequest("/message_comment_reactions", HttpMethod.Get, parameters, options);
        ...
        )
        {
            ...
            string responseJson = await FilesApi.SendRequest("/message_comment_reactions/{id}", HttpMethod.Get, parameters, options);
        ...
        )
        {
            ...
            string responseJson = await FilesApi.SendRequest("/message_comment_reactions", HttpMethod.Post, parameters, options);
        ...
        )
        {
            ...
            string responseJson = await FilesApi.SendRequest("/message_comment_reactions/{id}", HttpMethod.Delete, parameters, options);
