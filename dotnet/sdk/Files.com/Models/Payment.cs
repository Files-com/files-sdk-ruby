...
namespace Files.com.Models
{
    public class Payment
    {
        ...
        )
        {
            ...
            string responseJson = await FilesApi.SendRequest("/payments", HttpMethod.Get, parameters, options);

            return JsonSerializer.Deserialize<Payment[]>(responseJson);
        }
        ...
        )
        {
            ...
            string responseJson = await FilesApi.SendRequest("/payments/{id}", HttpMethod.Get, parameters, options);
